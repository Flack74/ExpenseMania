...
export function BudgetList({
  ...
  // Sort: total first, then highest pct
  progress.sort((a, b) => {
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <button
                    ...
                    className="rounded-lg p-1.5 text-muted-foreground opacity-100 hover:bg-primary/15 hover:text-primary sm:opacity-0 sm:transition-opacity sm:group-hover:opacity-100"
                  >
