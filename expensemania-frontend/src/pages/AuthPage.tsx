        ...
        <div className="flex flex-1 items-center justify-center">
          ...
          >
            <div className="mb-6 text-center sm:mb-8">
              ...
              <h1 className="font-display text-3xl font-bold tracking-normal text-foreground sm:text-4xl">ExpenseMania</h1>
                  ...
                  <Field label="Password" id="password">
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 grid h-8 w-8 -translate-y-1/2 place-items-center rounded-lg text-muted-foreground transition hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
